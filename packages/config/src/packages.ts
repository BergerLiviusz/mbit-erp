...
export const ERP_PACKAGES: Record<string, PackageDefinition> = {
  ...
  'workflow-only': {
    id: 'workflow-only',
    displayName: 'Workflow Edition',
    editionLabel: 'Workflow Edition',
    version: '1.0.1e',
    modules: {
      documents: false,
      team: true,
    ...
    buildName: 'mbit-erp-workflow-only',
    artifactSlug: 'workflow-only',
  ...
  'crm-dms-logistics': {
    id: 'crm-dms-logistics',
    displayName: 'CRM + DMS + Logistics Edition',
    editionLabel: 'CRM + DMS + Logistics Edition',
    version: '1.0.1g',
    modules: {
      documents: true,
      team: false,
    ...
    buildName: 'mbit-erp-crm-dms-logistics',
    artifactSlug: 'crm-dms-logistics',
