...
export const ERP_PACKAGES: Record<string, PackageDefinition> = {
  ...
  'dms-crm-workflow': {
    id: 'dms-crm-workflow',
    displayName: 'DMS + CRM + Workflow Edition',
    editionLabel: 'DMS + CRM + Workflow Edition',
    version: '1.0.1d',
    modules: {
      documents: true,
      team: true,
    ...
    buildName: 'mbit-erp-dms-crm-workflow',
    artifactSlug: 'dms-crm-workflow',
    artifactModuleLabel: 'DMS-CRM-WF',
    legacyIds: ['ERP_DMS_CRM_WORKFLOW', 'ERP_CRM_DMS_WORKFLOW'],
  },
  'ginop-crm-dms-hr': {
    id: 'ginop-crm-dms-hr',
