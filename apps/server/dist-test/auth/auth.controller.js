...
var AuthController = /** @class */ (function () {
    ...
    AuthController.prototype.register = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.authService.register(body.email, body.password, body.nev)];
            });
        });
    };
    AuthController.prototype.getAdminEmail = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.authService.getAdminEmail()];
            });
        });
    };
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:returntype", Promise)
    ], AuthController.prototype, "getAdminEmail", null);
