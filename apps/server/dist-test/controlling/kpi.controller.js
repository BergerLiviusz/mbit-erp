...
var KpiController = /** @class */ (function () {
    function KpiController(kpiService, auditService) {
        this.kpiService = kpiService;
        this.auditService = auditService;
    }
    KpiController.prototype.findAll = function (skip, take, aktiv, tipus) {
        return this.kpiService.findAll(skip ? parseInt(skip) : 0, take ? parseInt(take) : 50, {
            aktiv: aktiv === 'true' ? true : aktiv === 'false' ? false : undefined,
            tipus: tipus,
        });
    };
    KpiController.prototype.findOne = function (id) {
        return this.kpiService.findOne(id);
    };
    KpiController.prototype.calculateKPI = function (id) {
        return this.kpiService.calculateKPI(id);
    };
    KpiController.prototype.create = function (dto, req) {
        return __awaiter(this, void 0, void 0, function () {
            var kpi;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.kpiService.create(dto)];
                    case 1:
                        kpi = _b.sent();
                        return [4 /*yield*/, this.auditService.logCreate('KPI', kpi.id, kpi, (_a = req.user) === null || _a === void 0 ? void 0 : _a.id)];
                    case 2:
                        _b.sent();
                        return [2 /*return*/, kpi];
                }
    ...
    KpiController.prototype.update = function (id, dto, req) {
        return __awaiter(this, void 0, void 0, function () {
            var oldKpi, updated;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.kpiService.findOne(id)];
                    case 1:
                        oldKpi = _b.sent();
                        return [4 /*yield*/, this.kpiService.update(id, dto)];
                    case 2:
                        updated = _b.sent();
                        return [4 /*yield*/, this.auditService.logUpdate('KPI', id, oldKpi, updated, (_a = req.user) === null || _a === void 0 ? void 0 : _a.id)];
                    case 3:
                        _b.sent();
    ...
    KpiController.prototype.delete = function (id, req) {
        return __awaiter(this, void 0, void 0, function () {
            var oldKpi;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        oldKpi = _b.sent();
                        return [4 /*yield*/, this.kpiService.delete(id)];
                    case 2:
                        _b.sent();
                        return [4 /*yield*/, this.auditService.logDelete('KPI', id, oldKpi, (_a = req.user) === null || _a === void 0 ? void 0 : _a.id)];
                    case 3:
                        _b.sent();
                        return [2 /*return*/, { message: 'KPI törölve' }];
                }
            });
        });
    };
    ...
    __decorate([
        ...
        __metadata("design:paramtypes", [String]),
        __metadata("design:returntype", void 0)
    ], KpiController.prototype, "calculateKPI", null);
    __decorate([
        (0, common_1.Post)(),
        (0, rbac_decorator_1.Permissions)(permission_enum_1.Permission.KPI_MANAGE, permission_enum_1.Permission.REPORT_CREATE),
    ...
    KpiController = __decorate([
        (0, common_1.Controller)('controlling/kpi'),
