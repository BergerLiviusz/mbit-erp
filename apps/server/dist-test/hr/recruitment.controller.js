...
var RecruitmentController = /** @class */ (function () {
    function RecruitmentController(svc, storage) {
        this.svc = svc;
        this.storage = storage;
    }
    RecruitmentController.prototype.listPostings = function (allapot) {
        return this.svc.listPostings(allapot);
    };
    RecruitmentController.prototype.getPosting = function (id) {
        return this.svc.getPosting(id);
    };
    RecruitmentController.prototype.createPosting = function (body) {
        return this.svc.createPosting(body);
    };
    RecruitmentController.prototype.updatePosting = function (id, body) {
        return this.svc.updatePosting(id, body);
    };
    RecruitmentController.prototype.deletePosting = function (id) {
        return this.svc.deletePosting(id);
    };
    RecruitmentController.prototype.createApplication = function (postingId, body, file) {
        return __awaiter(this, void 0, void 0, function () {
            var cvFajlUtvonal, cvFajlNev;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(file === null || file === void 0 ? void 0 : file.buffer)) return [3 /*break*/, 2];
                        cvFajlNev = file.originalname;
                        return [4 /*yield*/, this.storage.saveFile('hr/cv', file.originalname, file.buffer)];
                    case 1:
                        cvFajlUtvonal = _a.sent();
                        _a.label = 2;
                    case 2: return [2 /*return*/, this.svc.createApplication({
                            postingId: postingId,
                            jelentkezoNev: body.jelentkezoNev,
                            email: body.email,
                            telefon: body.telefon,
                            cvFajlUtvonal: cvFajlUtvonal,
                            cvFajlNev: cvFajlNev,
    ...
    RecruitmentController.prototype.updateApplication = function (id, body) {
        return this.svc.updateApplication(id, body);
    };
    RecruitmentController.prototype.analytics = function () {
    ...
    ], RecruitmentController.prototype, "listPostings", null);
    __decorate([
        ...
        __metadata("design:paramtypes", [String]),
        __metadata("design:returntype", void 0)
    ], RecruitmentController.prototype, "getPosting", null);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:paramtypes", [String]),
        __metadata("design:returntype", void 0)
    ], RecruitmentController.prototype, "deletePosting", null);
    __decorate([
        (0, common_1.Post)('postings/:postingId/applications'),
        (0, rbac_decorator_1.Permissions)(permission_enum_1.Permission.HR_CREATE),
    ...
    __decorate([
        (0, common_1.Get)('analytics/status'),
        (0, rbac_decorator_1.Permissions)(permission_enum_1.Permission.HR_VIEW),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", void 0)
    ], RecruitmentController.prototype, "analytics", null);
    RecruitmentController = __decorate([
        (0, common_1.Controller)('hr/recruitment'),
        (0, common_1.UseGuards)(rbac_guard_1.RbacGuard),
        __metadata("design:paramtypes", [recruitment_service_1.HrRecruitmentService,
