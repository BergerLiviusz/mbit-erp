...
var ShipmentService = /** @class */ (function () {
    function ShipmentService(prisma, salesFlow) {
        this.prisma = prisma;
        this.salesFlow = salesFlow;
    }
    ShipmentService.prototype.findAll = function (orderId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.prisma.shipment.findMany({
                        where: orderId ? { orderId: orderId } : undefined,
                        include: {
                            order: {
    ...
    ShipmentService.prototype.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var shipment;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        shipment = _a.sent();
                        if (!shipment)
                            throw new common_1.NotFoundException('Szállítás nem található');
                        return [2 /*return*/, shipment];
                }
            });
        });
    };
    ShipmentService.prototype.createFromOrder = function (orderId, body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.salesFlow.createShipmentFromOrder(orderId, body)];
            });
        });
    };
