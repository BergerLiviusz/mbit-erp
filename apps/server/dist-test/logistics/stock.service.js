...
var StockService = /** @class */ (function () {
    ...
    StockService.prototype.getLowStock = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.prisma.stockLot.findMany({
                        where: {
                            OR: [
                                {
                                    mennyiseg: {
    ...
    StockService.prototype.createStockMove = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.prisma.stockMove.create({
                        data: data,
                    })];
            });
        });
    };
    StockService.prototype.getStockMovements = function (filters) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), total = _a[0], movements = _a[1];
