...
var AuditService = /** @class */ (function () {
    ...
    AuditService.prototype.log = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.prisma.auditLog.create({
                        data: __assign(__assign({}, data), { regi: data.regi ? JSON.stringify(data.regi) : null, uj: data.uj ? JSON.stringify(data.uj) : null }),
                    })];
            });
        });
    };
    AuditService.prototype.findAll = function () {
        return __awaiter(this, arguments, void 0, function (skip, take, entitas) {
