      ...
      >
        <form onSubmit={handleSubmit}>
          <div className="space-y-4">
            ...
            <DmsDocumentLinker
              label="Munkaköri leírás (DMS)"
              suggestionKey="munkakori_leiras"
              documentId={formData.jobDescriptionDocumentId || null}
              onLinked={(id) =>
                setFormData({ ...formData, jobDescriptionDocumentId: id || '' })
              }
            />
